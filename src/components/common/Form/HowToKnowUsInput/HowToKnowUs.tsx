...
import { StyleProps } from "./HowToKnowUs.styles"
import { useStyles } from "./HowToKnowUs.styles"
...
const HowToKnowUsInput: React.FC<properties> = (props) => {
...
export default HowToKnowUsInput
